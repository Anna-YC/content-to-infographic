...
| 4 | 宫崎骏风格 | 可自定义 | 治愈系/自然主题 |
| 5 | 复古海报风 | 可自定义 | 历史/经典/怀旧 |
| 6 | 赛博霓虹风 | 可自定义 | 未来/科技/酷炫 |
| 7 | 自然森系风 | 可自定义 | 环保/可持续发展 |
| 8 | 杂志编辑风 | 可自定义 | 深度文章/高端内容 |
| 9 | 蛋仔风格 | 可自定义 | 年轻化/可爱/游戏 |
| 10 | 新海诚风格 | 可自定义 | 风景/电影感/浪漫 |
| 11 | 素描风格 | 可自定义 | 艺术/手绘/简约 |
| 12 | 极简商务风 | 可自定义 | 商务汇报/企业培训 |
| 13 | 水墨国风 | 可自定义 | 传统文化/东方美学 |
| 14 | 像素游戏风 | 可自定义 | 游戏/编程/复古 |
| 15 | 波普艺术风 | 可自定义 | 潮流/品牌/创意 |
| 16 | 科幻太空风 | 可自定义 | 未来科技/太空探索 |
| 17 | 蒸汽朋克风 | 可自定义 | 机械/工业/复古科技 |
| 18 | 孟菲斯设计风 | 可自定义 | 创意/艺术/年轻化 |
| 19 | 日式浮世绘风 | 可自定义 | 日本文化/和风/艺术 |
| 20 | 3D 等距风 | 可自定义 | 数据可视化/产品展示 |

> 样式 1-3 为**主样式**，样式 4-20 为**备用样式**（用户未指定时随机选用）。所有样式均支持自定义落款，默认不加。
